...
if analyze_button and symbol:
    ...
    with st.spinner(f"🔄 Analyzing {symbol}..."):
        ...
        try:
            ...
            # ML Confidence for Current Signal
            if ML_AVAILABLE:
                ...
                try:
                    ...
                    with col3:
                        ...
                        st.metric("⭐ Quality" if prediction['is_elite'] else "📊 Quality", quality)
                    
                    if prediction['is_elite']:
                        st.warning(f"### ⭐ ELITE SIGNAL! Use 10-15% targets instead of {prediction['target']}%")
