...
def create_ichimoku_chart(df, tenkan, kijun, senkou_a, senkou_b, ema_13, ema_30, buy_signals, sell_signals, timeframe="Daily", ml_results=None):
    ...
    # Add ML confidence annotations for buy signals
    if ml_results and ml_results.get('buy_predictions'):
    ...
    if sell_signals:
        ...
        # Add ML confidence annotations for sell signals
        if ml_results and ml_results.get('sell_predictions'):
